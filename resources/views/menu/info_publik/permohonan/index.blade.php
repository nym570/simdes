		...
		<div class="card-body">
		  <div class="d-flex align-items-start justify-content-between">
			<div class="content-left">
			  <span>Pengajuan</span>
			  <div class="d-flex align-items-end mt-2">
				<h4 class="mb-0 me-2">{{array_key_exists("diajukan", $data)?$data["diajukan"]:0}}</h4>
			  </div>
			</div>
			<div class="avatar">
		...
		<div class="card-body">
		  <div class="d-flex align-items-start justify-content-between">
			<div class="content-left">
			  <span>Diproses</span>
			  <div class="d-flex align-items-end mt-2">
				<h4 class="mb-0 me-2">{{array_key_exists('diproses', $data)?$data['diproses']:0}}</h4>
			  </div>
			</div>
			<div class="avatar">
	...
	<div class="col-sm-6 col-xl-3">
	  <div class="card">
		<div class="card-body">
		  <div class="d-flex align-items-start justify-content-between">
			<div class="content-left">
			  <span>Selesai Dibayar</span>
			  <div class="d-flex align-items-end mt-2">
				<h4 class="mb-0 me-2">{{array_key_exists('dibayar', $data)?$data['dibayar']:0}}</h4>
			  </div>
			</div>
			<div class="avatar">
