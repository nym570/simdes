		...
		<div class="modal-dialog modal-lg ">
		  <div class="modal-content p-2 p-md-4">
			<div class="modal-header">
			  ...
			  <form id="formAuthentication" class="mb-3" action="{{ route('pengajuan.warga.suket.domisili.store') }}" data-remote="true" method="POST" enctype="multipart/form-data">
				@csrf
				...
				<div class="modal-body">
					...
					@if(auth()->user()->warga->dokumen_kk == null)
					<div class="row">
						<div class="col mb-3">
					...
					@endif
					@if(auth()->user()->warga->dokumen_ktp == null)
					<div class="row">
						<div class="col mb-3">
