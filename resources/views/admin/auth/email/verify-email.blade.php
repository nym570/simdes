<x-auth-layout title="Verification email">
	...
	<form id="formAuthentication" class="mb-3" action="{{ route('admin.verification.send') }}" method="POST">
		@csrf
	...
	<div class="text-center">
		<a href="{{ route('admin.logout') }}" class="d-flex align-items-center justify-content-center" onclick="logout()">
