		...
		<div class="modal-header">
		  ...
		  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			...
			<div class="modal-body">
				<a href="/import_format/admin.xlsx" download>Download Format Excel</a>
				<form id="formAuthentication" class="mb-3" action="{{ route('admin-list.import') }}" data-remote="true" method="POST" enctype="multipart/form-data">
					@csrf
